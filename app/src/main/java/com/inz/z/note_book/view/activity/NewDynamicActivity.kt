...
import com.inz.z.note_book.databinding.ActivityNewDynamicBinding
...
class NewDynamicActivity : BaseNoteActivity() {
    ...
    private var binding: ActivityNewDynamicBinding? = null
    ...
    override fun setViewBinding() {
        ...
        binding = ActivityNewDynamicBinding.inflate(layoutInflater)
            .apply {
                setContentView(root)
            }
    }
    ...
    override fun initView() {
        binding?.newDynamicTopSubmitTv?.setOnClickListener {
        ...
        setSupportActionBar(binding?.newDynamicTopBtal?.toolbar)
        ...
        binding?.newDynamicContentRv?.apply {
