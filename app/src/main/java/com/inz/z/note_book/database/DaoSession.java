...
public class DaoSession extends AbstractDaoSession {
    ...
    private final DaoConfig repeatInfoDaoConfig;
    ...
    private final RepeatInfoDao repeatInfoDao;
    ...
    public DaoSession(Database db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        repeatInfoDaoConfig = daoConfigMap.get(RepeatInfoDao.class).clone();
        repeatInfoDaoConfig.initIdentityScope(type);
        ...
        repeatInfoDao = new RepeatInfoDao(repeatInfoDaoConfig, this);
        ...
        registerDao(RepeatInfo.class, repeatInfoDao);
    ...
    public void clear() {
        ...
        repeatInfoDaoConfig.clearIdentityScope();
    ...
    public RepeatInfoDao getRepeatInfoDao() {
